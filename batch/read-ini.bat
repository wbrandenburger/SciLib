...
REM @URIHelp]: https://stackoverflow.com/questions/2866117/windows-batch-script-to-read-an-ini-file
...
REM evaluating input -----------------------------------------------------------
REM ============================================================================

REM read-ini.bat /i item [/s section] inifile
REM read-ini.bat /i item /v value [/s section] inifile
REM read-ini.bat /d item [/s section] inifile
...
:begin
if "%~1"=="" goto usage
for %%I in (item value section found next) do set %%I=
for %%I in (%*) do (
    if defined next (
